#!/usr/bin/env node
/**
 * Delete leftover acct-e2e-* throwaway repos for abdull-ah-med + aqsa-05 ONLY.
...
const ALLOWED = new Set(["abdull-ah-med", "aqsa-05"]);
...
console.log("=== cleanup acct-e2e-* (abdull-ah-med + aqsa-05 ONLY) ===\n");
